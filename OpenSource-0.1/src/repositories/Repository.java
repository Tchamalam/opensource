...
public interface Repository<T> {
	 ...
	 * @throws Exception incase an unexpected error occurs while getting the object form the database.
	 */
	 ...
	 * @throws Exception in case an incase an unexpected error occurs while
	 * getting the object form the database.
	 */
	public void delete(String name) throws Exception;
	
	/**
	 * Given an element of type T(to be specified during implemetation), update its contents.
	 * Beware that if no matching is found in the database, it get saved.
	 * @param element The object of the element to be saved.
	 * @throws Exception incase an unexpected error occurs while 
	 * getting the object form the database.
	 */
	public void update(T element) throws Exception;
	
	/**
	 * Create an object and saves it to the databse.
